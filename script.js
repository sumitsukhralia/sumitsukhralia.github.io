...
// NASA APOD API key - DEMO_KEY has low rate limits; get your own key at https://api.nasa.gov/
...
async function fetchAPOD() {
  try {
    ...
    fetchButton.textContent = "Fetch Today's APOD";
  }
}

// Fetch APOD on button click
fetchButton.addEventListener('click', fetchAPOD);

// Optional: fetch immediately on page load
fetchAPOD();
